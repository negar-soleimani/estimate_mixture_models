...
for (v in 1:n_samples) {
  ...
  res <- mcmc_step6(y, t, n_iter, init, sigma_proposals,
                    ...
                    alpha_init = FALSE, psi_init = FALSE, k_init = FALSE, Sigma_theta, n_burnin=1000)
...
result_m2_sh2_psi1_ortho_ex <- list(g_chain, h0_chain, sigma_chain, alpha_chain, psi_chain, k_chain, delta_list, zeta_list, loglik_mat, accept_rate)
