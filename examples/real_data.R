...
par(mfrow = c(2, 3))
boxplot(results_real_sh2$theta[,1],
        xlab = "Blue Basketball", ylab = "g")
boxplot(results_real_sh2$theta[,2],
        xlab = "Blue Basketball", ylab = "h0")
boxplot(results_real_sh2$theta[,3],
        xlab = "Blue Basketball", ylab = expression(sigma[err]^2))
boxplot(results_real_sh2$theta[,4],
        xlab = "Blue Basketball", ylab = expression(alpha))
boxplot(results_real_sh2$theta[,5],
        xlab = "Blue Basketball", ylab = expression(psi[delta]))
boxplot(results_real_sh2$theta[,6],
        xlab = "Blue Basketball", ylab = "k")

prob_zeta_model1 <- colMeans(results_real_sh2$zeta == 1)
print(prob_zeta_model1)

prob_zeta_model2 <- colMeans(results_real_sh2$zeta == 2)
print(prob_zeta_model2)

par(mfrow = c(3, 2))
plot(results_real_sh2$theta[, 1], type = "l", main = "Trace of g")
plot(results_real_sh2$theta[, 2], type = "l", main = "Trace of h0")
plot(results_real_sh2$theta[, 3], type = "l", ylim = c(0, 1), main = "Trace of sigma_sq_err")
